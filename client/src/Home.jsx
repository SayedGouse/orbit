    ...
    <div className="Hero">
        <div className="row align-items-center" style={{backgroundColor: '#F9F6E9'}}>
            ...
            <div className="col-12 col-md-6 dtr-sm-mt-50"><img src="image 10.png" alt="image"
                    className="dtr-mb-minus50 animated-img"/></div>
        </div>
    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4 foot-col mb-2">
                            ...
                            <ul class="p-0">
                                ...
                                <li class="list-unstyled mb-1"><a href="#"
                                        class="text-decoration-none text-dark"></a>Managed Service Provider</li>
                                <li class="list-unstyled mb-1"><a href="#"
                                        class="text-decoration-none text-dark">Digital
                                        Marketing</a></li>
                                <li class="list-unstyled mb-1"><a href="#"
                                        class="text-decoration-none text-dark"></a>SEO
                                </li>
                            </ul>
                        </div>
                        <div class="col-lg-3 foot-col mb-2">
                            ...
                            <ul class="p-0">
                                ...
                                <li class="list-unstyled mb-1"><a href="#"
                                        class="text-decoration-none text-dark"></a>Sumort
                                </li>
                            </ul>
                        </div>
                        <div class="col-lg-3 foot-col mb-2">
                            ...
                            <ul class="p-0">
                                ...
                                <li class="list-unstyled mb-1"><a href="#"
                                        class="text-decoration-none text-dark"></a>Call
                                    Us</li>
                            </ul>
                        </div>
