...
const Home = () => {
    return (
        <>
            ...
            <nav className="navbar navbar-expand-lg navbar-light">
                <div className="container-fluid">
                    <a className="navbar-brand" href="#">
                        <img className='img-fluid' src="orbit logo 11.png" alt="" srcset="" />
                    </a>
                                ...
                                <ul className="dropdown-menu p-3" aria-labelledby="navbarDropdown">
                                    <div className="row">
                                        <div className="col-lg-3">
                                            <ul>
                                                <li className=" list-unstyled"><a className="dropdown-item color-black" href="#">
                                                    <h5 className="text-center">Services</h5>
                                                </a>
                                                </li>
                                                <li className=" list-unstyled"><a className="dropdown-item" href="#">Web Development</a>
                                                </li>

                                                <li className=" list-unstyled"><a className="dropdown-item" href="#">App Development</a>
                                                </li>
                                                <li className=" list-unstyled"><a className="dropdown-item" href="#">Cloud Solutions</a>
                                                </li>
                                                <li className=" list-unstyled"><a className="dropdown-item" href="#">Managed Service
                                                    Providers</a>
                                                </li>
                                                <li className=" list-unstyled"><a className="dropdown-item" href="#">Digital
                                                    Marketing</a>
                                                </li>
                                                <li className=" list-unstyled"><a className="dropdown-item" href="#">SEO</a>
                                                </li>
                                            </ul>
                                        </div>
                                        ...
                                        <div className="col-lg-3">
                                            <ul>
                                                ...
                                                <li className=" list-unstyled"><a className="dropdown-item" href="#">Ticketing
                                                    System</a>
                                                </li>
                                                <li className=" list-unstyled"><a className="dropdown-item" href="#">Billing System</a>
                                                </li>
                                                <li className=" list-unstyled"><a className="dropdown-item" href="#">PMS</a></li>
                                            </ul>
                                        </div>
                                        ...
                                        <div className="col-lg-3">
                                            <ul>
                                                ...
                                                <li className=" list-unstyled"><a className="dropdown-item" href="#">Careers</a>
                                                </li>
                                                <li className=" list-unstyled"><a className="dropdown-item" href="#">Team</a></li>
                                                <li className=" list-unstyled"><a className="dropdown-item" href="#">Blog</a></li>
                                                <li className=" list-unstyled"><a className="dropdown-item" href="#">About Orbit</a>
                                                </li>
                                            </ul>
                                        </div>
                                        ...
                                        <div className="col-lg-3">
                                            <ul>
                                                ...
                                                <li className=" list-unstyled"><a className="dropdown-item" href="#">Lorem</a>
                                                </li>
                                                <li className=" list-unstyled"><a className="dropdown-item" href="#">Ipsum</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </ul>
            ...
            <div className="Hero">
                <div className="row align-items-center" style={{ backgroundColor: '#F9F6E9' }}>
                    <div className="col" style={{ paddingLeft: '5%' }}>
                        ...
                        <a href="#" className="btn btn-warning align-items-center">Learn more </a>
                    </div>

                    <div className="col-12 col-md-6 dtr-sm-mt-50"><img src="image 10.png" alt="image"
                        className="img-fluid dtr-mb-minus50 animated-img" /></div>
                </div>
            </div>
            ...
            <div className="container_home mt-5">
                <div className="text-center">
                    <h3 className="text-center mb-4">It is a long established fact that</h3>
                    <div className="row">
                        <div className="col-lg-4">
                            <img src="image 11.png" alt="" srcset="" />
                            <p><a href="slider.html" className="text-dark">Go to your website</a></p>
                        </div>
                        <div className="col-lg-4">
                            <img src="image 12.png" alt="" srcset="" />
                            <p><a href="slider.html" className="text-dark">Go to cloud</a></p>
                        </div>
                        <div className="col-lg-4">
                            <img src="image 13.png" alt="" srcset="" className="mb-3" />
                            <p><a href="slider.html" className="text-dark">Lets Scale</a></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            {/* <!-- services --> */}
            <div class="container_home px-5">
                <div class="row row-cols-1 row-cols-md-3 g-4 mt-5 p-2">
                    <div class="col">
                        <div class="card h-100 border-0">
                            <img src="image 7.png" class="card-img-top" alt="..." />
                            <div class="card-body">
                                <h5 class="card-title">Websites Development</h5>
                                <p class="card-text">Lorem Ipsum is simply dummy text of the printing and typesetting
                                    industry.
                                </p>
                                <div class="text-center">
                                    <a class="text-decoration-none" style={{ color: '#F3AF60' }} href="/slider"
                                    >LEARN MORE </a>
                    ...
                    <div class="col">
                        <div class="card h-100  border-0">
                            <img src="image 8.png" class="card-img-top" alt="..." />
                            <div class="card-body">
                ...
                <div class="footer p-4">
                    <div class="row">
                        <div class="col-md-4 mb-5">
                            <img src="orbitlogo.png" alt='not found' class="img-fluid w-30 h-30" />
                            <p class="pt-4">providing path to individuals and <br />
                            ...
                            <div class="row">
                                <div class="col-lg-4 foot-col mb-2">
                                    ...
                                    <ul class="p-0">
                                        ...
                                        <li class="list-unstyled mb-1"><a href="#" class="text-decoration-none text-dark">Cloud
                                            Solutions</a></li>
                                        <li class="list-unstyled mb-1"><a href="#" class="text-decoration-none text-dark">Managed Service Provider</a></li>
                                        <li class="list-unstyled mb-1"><a href="#"
                                            class="text-decoration-none text-dark">Digital
                                            Marketing</a></li>
                                        <li class="list-unstyled mb-1"><a href="#" class="text-decoration-none text-dark">SEO</a></li>
                                    </ul>
                                </div>
                                <div class="col-lg-3 foot-col mb-2">
                                    ...
                                    <ul class="p-0">
                                        ...
                                        <li class="list-unstyled mb-1"><a href="#"
                                            class="text-decoration-none text-dark">Careers</a></li>
                                        <li class="list-unstyled mb-1"><a href="#"
                                            class="text-decoration-none text-dark">Blog</a>
                                        </li>
                                ...
                                <div class="col-lg-3 foot-col mb-2">
                                    ...
                                    <ul class="p-0">
                                        <li class="list-unstyled mb-1"><a href="#"
                                            class="text-decoration-none text-dark">Email</a>
                                        </li>
                                        <li class="list-unstyled mb-1"><a href="#" class="text-decoration-none text-dark">Call us</a></li>
                                    </ul>
                                </div>
                                <div class="col-lg-2 foot-col">
                                    <h4>Follow Orbit</h4>
                                    <a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="21"
                                    ...
                                    <a href="#"> <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                        ...
                                        <defs>
                                            <radialGradient id="paint0_radial_158_10" cx="0" cy="0" r="1"
                                            ...
                                            <radialGradient id="paint1_radial_158_10" cx="0" cy="0" r="1"
                                                gradientUnits="userSpaceOnUse"
